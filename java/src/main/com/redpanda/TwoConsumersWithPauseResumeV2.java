...
public class TwoConsumersWithPauseResumeV2 {
    ...
    private static volatile boolean mainThreadPaused = true;

    private static final Condition mainThreadCondition = lock.newCondition();
    ...
    public static void resumeMainThread() {
        ...
        try {
            ...
            System.out.println("Main thread signaled to resume.");
        } finally {
            lock.unlock();
        }
    }
    ...
    public static void pauseMainThread() {
        ...
        try {
            ...
            mainThreadCondition.signal();
            System.out.println("Main thread signaled to pause.");
        } finally {
            lock.unlock();
        }
    }
